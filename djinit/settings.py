...
# Get the djinit_ENVIRON value to load the env variables
server_env = os.environ.get('DJINIT_ENVIRON') or 'development'
...
ROOT_URLCONF = 'djinit.core.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR / 'djinit/templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'djinit.core.wsgi.application'
