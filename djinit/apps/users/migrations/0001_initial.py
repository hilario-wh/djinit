...
import djinit.apps.users.models
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefono', models.CharField(blank=True, max_length=15, validators=[django.core.validators.RegexValidator(message='Ingrese solo números.', regex='^\\d+$')])),
                ('pais', django_countries.fields.CountryField(max_length=2)),
                ('detalles', models.TextField(blank=True, verbose_name='Detalles')),
                ('logo', models.ImageField(upload_to=djinit.apps.users.models.Empresa.logo_path)),
            ...
            options={
                ...
                'permissions': {('ver_perfil_financiero', 'Ver perfil financiero'), ('lista_empresas', 'Lista de empresas'), ('eliminar_superusuarios', 'Eliminar super usuarios'), ('acciones_lista_empresas', 'Acciones lista de empresas'), ('crear_superusuarios', 'Crear super usuarios')},
            },
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('avatar', models.ImageField(default='usuarios/avatar.png', upload_to='usuarios/%Y/%m/')),
                ...
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='company_user', to='users.empresa', verbose_name='Empresa')),
